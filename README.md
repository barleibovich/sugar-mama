...
- OCR assist for reading values from a photo/camera when adding a measurement.
...
- `src/components/AddMeasurementModal.tsx`: Add measurement form with optional OCR.
